...
function addItem(e) {
    e.preventDefault();
    const value = grocery.value.trim(); // Убираем лишние пробелы в начале и в конце строки
    ...
    if (value !== "" && !editFlag) {
        ...
        if (!isItemDuplicate(value)) {
            ...
            displayAlert("item already exists", "danger");
        }
...
function isItemDuplicate(value) {
...
list.addEventListener("click", function (e) {
    if (e.target.classList.contains("title")) {
        toggleItemCompletion(e.target.parentElement);
